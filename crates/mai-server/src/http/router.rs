...
pub(crate) fn create_router(state: Arc<AppState>) -> Router {
    Router::new()
        ...
        .route(
            "/projects/{id}/pull-request-reviews/lifecycle-status/refresh",
            post(handlers::projects::refresh_project_pull_request_state),
        )
        .route(
        ...
        .route(
            "/projects/{id}/review-jobs/{job_id}",
            get(handlers::projects::get_project_review_job),
        )
        .route(
